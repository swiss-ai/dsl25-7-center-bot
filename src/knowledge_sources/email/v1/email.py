...
# from talon import quotations  # Commented out - requires talon email reply parsing library
...
def _split(body: str) -> Tuple[str, str]:
    try:
        # Try different talon API signatures
        fresh = quotations.extract_from(body).strip()
    except Exception as e:
        # If talon fails, just use the whole body as fresh content
        fresh = body.strip()
